...
'Modulbeschreibung:
'Programmlogik zum Worksheet-Vergleich
'--> evtl. auslagern in Modul
...
Private Sub UserForm_Initialize()
    frmWorksheetVergleich.Caption = GetText("ELP_002")
    frmWorksheetVergleich.btnStart.Caption = GetText("ELP_003")

    Call modAuxiliary.PlaceUserFormInCenter(Me)
    
    If xlef_blnScreenUpdate Then Call optionsScreenUpdateON 'ToDo... was machen wir da???
'    MsgBox "Screenupdate: " & Application.ScreenUpdating
End Sub

Private Sub UserForm_QueryClose(Cancel As Integer, CloseMode As Integer)
    Call optionsScreenUpdateOFF 'ToDo... was machen wir da???
'    MsgBox "Screenupdate: " & Application.ScreenUpdating
End Sub
